...
((("Ethereum (generally)","about", id="ix_01what-is-asciidoc0", range="startofrange")))اتریوم ((("world computer, Ethereum as")))اغلب به عنوان «رایانه‌ی جهانی» توصیف میشود اما این به چه معناست؟ بیایید یک توضیح باتوجه به علوم رایانه ارایه دهیم, and then try to decipher that with a more practical analysis of Ethereum's capabilities and characteristics, while comparing it to Bitcoin and other decentralized information exchange platforms (or "blockchains" for short).
